...
public class AlarmView extends LinearLayout {
    ...
    protected void onFinishInflate() {
    	...
    	lvAlarmList.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
			...
			public boolean onItemLongClick(AdapterView<?> parent, View view,
				...
				new AlertDialog.Builder(getContext()).setTitle("Options").setItems(new CharSequence[]{"Delete"},
    ...
    private void deletAlarm(int position){
    ...
    private void addAlarm(){
    	...
    	new TimePickerDialog(getContext(), new TimePickerDialog.OnTimeSetListener() {
			...
			public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
				...
				adapter.add(ad);
				adapter.add(new AlarmDate(calendar.getTimeInMillis()));
...
//    	editor.putString(KEY_ALARM_LIST, sb.toString().substring(0, sb.length()-1));
    ...
    private static class AlarmDate{
    	public AlarmDate(long time){
    		...
    		timeLabel = String.format("%dMonth%dDate %d:%d", 
